---
name: 'GLPI standards'
description: 'Coding conventions for GLPI files'
applyTo: '**/*.php'
---
# PHP GLPI coding standards
...
- Always ensure that your code is well-documented and follows the GLPI documentation standards.